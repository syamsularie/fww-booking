...
type PaymentExecutor interface {
	...
	GetPaymentDetailByReservationID(reservationID int) (model.PaymentDetailResponse, error)
}
...
func (s *PaymentUsecase) GetPaymentDetailByReservationID(reservationID int) (model.PaymentDetailResponse, error) {
	var paymentDetailResponse model.PaymentDetailResponse

	paymentDetail, err := s.PaymentRepo.GetPaymentDetailByReservationID(reservationID)
	if err != nil {
		return paymentDetailResponse, err
	}
